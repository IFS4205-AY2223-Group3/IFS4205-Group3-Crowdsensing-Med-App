# Generated by Django 4.1 on 2022-09-26 10:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HealthRecord',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='backend.patient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='backend.patient')),
                ('exam_id', models.CharField(max_length=10, unique=True)),
                ('approved', models.BooleanField(default=False)),
                ('doctor', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.doctor')),
            ],
        ),
    ]
