"use strict";var De=Object.defineProperty,on=Object.getOwnPropertyDescriptor,ze=Object.getOwnPropertyNames,cn=Object.prototype.hasOwnProperty,Y=(e,t)=>function(){return e&&(t=(0,e[ze(e)[0]])(e=0)),t},W=(e,t)=>function(){return t||(0,e[ze(e)[0]])((t={exports:{}}).exports,t),t.exports},He=(e,t)=>{for(var n in t)De(e,n,{get:t[n],enumerable:!0})},un=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of ze(t))!cn.call(e,s)&&s!==n&&De(e,s,{get:()=>t[s],enumerable:!(r=on(t,s))||r.enumerable});return e},Ne=e=>un(De({},"__esModule",{value:!0}),e),L=Y({"<define:process>"(){}}),ln=W({"src/utils/is-non-empty-array.js"(e,t){"use strict";L();function n(r){return Array.isArray(r)&&r.length>0}t.exports=n}}),hn=W({"src/language-js/loc.js"(e,t){"use strict";L();var n=ln();function r(l,P){let{ignoreDecorators:p}=P||{};if(!p){let x=l.declaration&&l.declaration.decorators||l.decorators;if(n(x))return r(x[0])}return l.range?l.range[0]:l.start}function s(l){return l.range?l.range[1]:l.end}function a(l,P){let p=r(l);return Number.isInteger(p)&&p===r(P)}function i(l,P){let p=s(l);return Number.isInteger(p)&&p===s(P)}function h(l,P){return a(l,P)&&i(l,P)}t.exports={locStart:r,locEnd:s,hasSameLocStart:a,hasSameLoc:h}}}),pn=W({"node_modules/angular-estree-parser/node_modules/lines-and-columns/build/index.js"(e){"use strict";L(),e.__esModule=!0,e.LinesAndColumns=void 0;var t=`
